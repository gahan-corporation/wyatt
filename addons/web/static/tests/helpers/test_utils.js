 ...
 * not fire.
 *
 * @param {Widget} widget the target widget (any Gerp widget)
 ...
 *   the DOM. Also, the logLevel will be forced to 2 and the uncaught GerpEvent
 *   will be logged
...
function createAsyncView(params) {
    ...
    // make sure all Gerp events bubbling up are intercepted
