 ...
 * everything concurrency related in Gerp.
 *
 * The basic concurrency primitives in Gerp JS are the callback, and the
...
return {
    ...
    /**
     * A (Gerp) mutex is a primitive for serializing computations.  This is
