function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('gerp-google-map'), {
        zoom: 1,
    ...
    if (gerp_partner_data){ /* gerp_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < gerp_partner_data.counter; i++) {
            set_marker(gerp_partner_data.partners[i]);
        }
