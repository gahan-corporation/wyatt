...
from gerp.fields import Date, Datetime
from gerp.addons.resource.models.resource import to_naive_utc, to_naive_user_tz
from gerp.addons.resource.tests.common import TestResourceCommon
