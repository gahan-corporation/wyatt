...
from gerp.addons.event.tests.common import TestEventCommon
from gerp.exceptions import ValidationError, UserError, AccessError
...
class TestEventFlow(TestEventCommon):
    ...
    def test_event_date_range(self):
        self.patcher = patch('gerp.addons.event.models.event.fields.Datetime', wraps=Datetime)
