...
Gerp is an <a href="https://www.gerp.com/page/e-commerce">Open Source eCommerce</a>
...
Gerp's unique *'edit inline'* and building blocks approach makes product pages
...
Gerp's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Gerp's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Gerp marketing tools (mass mailing, campaigns, etc) are also linked with
...
SEO tools are ready to use, with no configuration required. Gerp suggests
...
Create new landing pages easily with the Gerp inline edition feature. Send
...
Benefit from the power of Gerp, in your online store: a powerfull tax engine,
...
Everything is integrated with Gerp. No pain, real time.
