...
class TestUi(gerp.tests.HttpCase):
    def test_01_pos_basic_order(self):
        ...
        self.phantom_js("/pos/web",
                        "gerp.__DEBUG__.services['web_tour.tour'].run('pos_pricelist')",
                        "gerp.__DEBUG__.services['web_tour.tour'].tours.pos_pricelist.ready",
                        login="admin")

        self.phantom_js("/pos/web",
                        "gerp.__DEBUG__.services['web_tour.tour'].run('pos_basic_order')",
                        "gerp.__DEBUG__.services['web_tour.tour'].tours.pos_basic_order.ready",
                        login="admin")
