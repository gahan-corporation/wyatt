...
from gerp.tools import float_compare, mute_logger, test_reports
from gerp.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('gerp.addons.point_of_sale.models.pos_order'):
