gerp.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.gerp[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.gerp[callback + '_editor']) {
                window.top.gerp[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.gerp[callback + '_downup']) {
                    window.top.gerp[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
gerp.define('web_editor.IframeRoot.instance', function (require) {
'use strict';
...
gerp.define('web_editor.IframeRoot', function (require) {
'use strict';
