...
class TestMailgateway(TestMail):
    ...
    @mute_logger('gerp.addons.mail.models.mail_thread')
    ...
    @mute_logger('gerp.addons.mail.models.mail_thread', 'gerp.models')
    ...
    @mute_logger('gerp.addons.mail.models.mail_thread', 'gerp.models', 'gerp.addons.mail.models.mail_mail')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by gerp should update thread accordingly """
    ...
    def test_message_process_model_res_id(self):
        ...
        # Gerp 10 update: compat mode has been removed and should not work anymore
        ...
        # Gerp 10 update: compat mode has been removed and should not work anymore and does not depend from hostname
        self.assertRaises(ValueError,
                          self.format_and_process,
                          MAIL_TEMPLATE, email_from='other5@gmail.com',
    ...
    def test_forward_parent_id(self):
        ...
        # tmp
        from gerp.addons.mail.tests.test_mail_model import MailTest
