...
""" + index_style + """
    ...
    <body>
        ...
        <a href='https://www.gerp.com/documentation/user/point_of_sale/posbox/index.html'>the manual</a>.
        </p>
        <p>
...
class PosboxHomepage(gerp.addons.web.controllers.main.Home):
...
"""
    ...
    def connect_to_wifi(self, essid, password, persistent=False):
        ...
        subprocess.call(['/home/pi/gerp/addons/point_of_sale/tools/posbox/configuration/connect_to_wifi.sh', essid, password, persistent])
        return "connecting to " + essid

    @http.route('/wifi_clear', type='http', auth='none', cors='*')
    def clear_wifi_configuration(self):
        os.system('/home/pi/gerp/addons/point_of_sale/tools/posbox/configuration/clear_wifi_configuration.sh')
