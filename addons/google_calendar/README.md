...
forget an event, fully synchronized with the Gerp <a href="https://www.gerp.com/page/crm">Open Source CRM</a>.
...
You can ask to have a alarm of type 'notification' in your Gerp.  You will have
a notification in you Gerp which ever the page you are.

Google Calendar
---------------

With the plugin Google\_calendar, you can synchronize your Gerp calendar with Google Calendar.
