...
def test_single():
     ...
     */
    gerp.define('supermodule', function (req) {
        var other = req('other');
    });
    """)
...
def test_multiple():
    ...
    gerp.define('module1', function (req) {
        return 1;
    });
    gerp.define('module2', function (req) {
        return req('dep2');
    });
    gerp.define('module3', function (req) {
        var r = req('dep3');
        return r;
    });
    """)
...
def test_export_instance():
    [mod] = parse("""
    gerp.define('module', function (require) {
...
def test_bounce():
    [m2, m1] = parse("""
    gerp.define('m2', function (require) {
        var Item = require('m1');
        return {
            Item: Item
        };
    });
    gerp.define('m1', function (require) {
        var Class = require('Class');
...
def test_reassign():
    [m] = parse("""
    gerp.define('m', function (require) {
        var Class = require('Class');
        /** local class */
