...
from gerp.addons.payment_buckaroo.controllers.main import BuckarooController
from gerp.tools import mute_logger


@gerp.tests.common.at_install(False)
@gerp.tests.common.post_install(False)
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('gerp.addons.payment_buckaroo.models.payment', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@gerp.com',
