...
class TestUi(gerp.tests.HttpCase):
    ...
    def test_01_admin_forum_tour(self):
        self.phantom_js("/", "gerp.__DEBUG__.services['web_tour.tour'].run('question')", "gerp.__DEBUG__.services['web_tour.tour'].tours.question.ready", login="admin")
    ...
    def test_02_demo_question(self):
        ...
        self.phantom_js("/", "gerp.__DEBUG__.services['web_tour.tour'].run('forum_question')", "gerp.__DEBUG__.services['web_tour.tour'].tours.forum_question.ready", login="demo")
