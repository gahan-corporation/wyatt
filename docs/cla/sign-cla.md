...
In order for your contribution to Gerp to be accepted, you have to sign the
Gerp Contributor License Agreement (CLA). More information about this
...
3. An Gerp R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is Gerp, the file would be
    `doc/cla/corporate/gerp.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Gerp Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `gerp.com`.  In that case someone from the Gerp team will
make the pull request on your behalf.

* Printable Gerp CCLA v1.0 https://www.gerp.com/files/legal/Gerp-CCLA-v1.0.pdf
* Printable Gerp ICLA v1.0 https://www.gerp.com/files/legal/Gerp-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Gerp is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Gerp project

* protect the Gerp project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Gerp project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Gerp project under specific
...
The Gerp CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Gerp S.A. to use, modify and
...
(ICLA) of Gerp.  The agreement is executed by adding your name and
