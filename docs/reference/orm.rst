...
Accessing a relational field (:class:`~gerp.fields.Many2one`,
:class:`~gerp.fields.One2many`, :class:`~gerp.fields.Many2many`)
...
.. danger::
    ...
    (to the same value), use :meth:`~gerp.models.Model.write`::
...
:meth:`~gerp.models.Model.filtered`
...
The :class:`~gerp.api.Environment` stores various contextual data used by
...
using :attr:`~gerp.models.Model.env` and gives access to the current user
(:attr:`~gerp.api.Environment.user`), the cursor
(:attr:`~gerp.api.Environment.cr`) or the context
(:attr:`~gerp.api.Environment.context`)::
...
:meth:`~gerp.models.Model.with_context`
...
:meth:`~gerp.models.Model.with_env`
...
:meth:`~gerp.models.Model.search`
   ...
   .. tip:: to just check if any record matches a domain, or count the number
             ...
             :meth:`~gerp.models.Model.search_count`
:meth:`~gerp.models.Model.create`
...
:meth:`~gerp.models.Model.ensure_one`
...
* computed fields are automatically checked and recomputed, they do not need
  an ``onchange``
* for non-computed fields, the :func:`~gerp.api.onchange` decorator is used
...
The :attr:`~gerp.api.Environment.cr` attribute on environments is the
...
Because models use the same cursor and the :class:`~gerp.api.Environment`
...
:meth:`~gerp.api.Environment.invalidate_all` method of the
:class:`~gerp.api.Environment` object.
...
* values of the :class:`~gerp.api.Environment` (cursor, user id and
  context) are passed explicitly to methods instead
* record data (:attr:`~gerp.models.Model.ids`) are passed explicitly to
...
.. currentmodule:: gerp.models

.. autoclass:: gerp.models.Model
    ...
    .. attribute:: _table
        ...
        :attr:`~gerp.models.Model._auto`, automatically generated by
        default.
    ...
    .. attribute:: _inherits
        ...
        the fields of the :attr:`~gerp.models.Model._inherits`-ed model but
        ...
        .. warning::
            ...
            :attr:`~gerp.models.Model._inherits`-ed
    ...
    .. attribute:: id
        ...
        Identifier :class:`field <gerp.fields.Field>`
    ...
    .. attribute:: create_date
        ...
        :type: :class:`~gerp.field.Datetime`
    ...
    .. attribute:: active
        ...
        :type: :class:`~gerp.fields.Boolean`
    ...
    .. attribute:: sequence
        ...
        :type: :class:`~gerp.fields.Integer`

    .. attribute:: state

        lifecycle stages of the object, used by the ``states`` attribute on
        :class:`fields <gerp.fields.Field>`

        :type: :class:`~gerp.fields.Selection`
    ...
    .. attribute:: parent_id
        ...
        :type: :class:`~gerp.fields.Many2one`
...
.. autodoc documents descriptors as attributes, even for the *definition* of
   descriptors. As a result automodule:: gerp.fields lists all the field
...
.. autoclass:: gerp.fields.Field

.. autoclass:: gerp.fields.Char
    :show-inheritance:

.. autoclass:: gerp.fields.Boolean
    :show-inheritance:

.. autoclass:: gerp.fields.Integer
    :show-inheritance:

.. autoclass:: gerp.fields.Float
    :show-inheritance:

.. autoclass:: gerp.fields.Text
    :show-inheritance:

.. autoclass:: gerp.fields.Selection
    :show-inheritance:

.. autoclass:: gerp.fields.Html
    :show-inheritance:

.. autoclass:: gerp.fields.Date
    :show-inheritance:
    :members: today, context_today, from_string, to_string

.. autoclass:: gerp.fields.Datetime
    :show-inheritance:
...
.. autoclass:: gerp.fields.Many2one
    :show-inheritance:

.. autoclass:: gerp.fields.One2many
    :show-inheritance:

.. autoclass:: gerp.fields.Many2many
    :show-inheritance:

.. autoclass:: gerp.fields.Reference
    :show-inheritance:
...
.. literalinclude:: ../../gerp/addons/test_documentation_examples/inheritance.py
    :language: python
    :lines: 5-

and using them:

.. literalinclude:: ../../gerp/addons/test_documentation_examples/tests/test_inheritance.py
    :language: python
    :lines: 10,11,14,19
...
When using :attr:`~gerp.models.Model._inherit` but leaving out
:attr:`~gerp.models.Model._name`, the new model replaces the existing one,
...
.. literalinclude:: ../../gerp/addons/test_documentation_examples/extension.py
    :language: python
    :lines: 5-

.. literalinclude:: ../../gerp/addons/test_documentation_examples/tests/test_extension.py
    :language: python
    :lines: 8,13
...
at runtime) but less power: using the :attr:`~gerp.models.Model._inherits`
...
:class:`~gerp.fields.Reference` fields automatically set up on the parent
model:

.. literalinclude:: ../../gerp/addons/test_documentation_examples/delegation.py
    :language: python
    :lines: 5-

.. literalinclude:: ../../gerp/addons/test_documentation_examples/tests/test_delegation.py
    :language: python
    :lines: 11-14,23,28
...
``field_name`` (``str``)
    ...
    a :class:`~gerp.fields.Many2one` using dot-notation e.g. ``'street'``
...
``operator`` (``str``)
    ...
    ``child_of``
        ...
        :attr:`~gerp.models.Model._parent_name`).
...
* :meth:`~gerp.models.Model.search` returns a recordset, no point in e.g.
  browsing its result
* ``fields.related`` and ``fields.function`` are replaced by using a normal
  field type with either a ``related=`` or a ``compute=`` parameter
* :func:`~gerp.api.depends` on ``compute=`` methods **must be complete**,
...
* the decorators :func:`~gerp.api.model` and :func:`~gerp.api.multi` are
  for bridging *when calling from the old API context*, for internal or pure
  new-api (e.g. compute) they are useless
* remove :attr:`~gerp.models.Model._default`, replace by ``default=``
...
* the normal new-api import is ``from gerp import fields, models``. If
  ...
  fields, models``
* avoid the :func:`~gerp.api.one` decorator, it probably does not do what
  you expect
* remove explicit definition of :attr:`~gerp.models.Model.create_uid`,
  :attr:`~gerp.models.Model.create_date`,
  :attr:`~gerp.models.Model.write_uid` and
  :attr:`~gerp.models.Model.write_date` fields: they are now created as
...
* when straight conversion is impossible (semantics can not be bridged) or the
  ...
  implementations for the same method name using :func:`~gerp.api.v7` and
  :func:`~gerp.api.v8`. The method should first be defined using the
  old-API style and decorated with :func:`~gerp.api.v7`, it should then be
  re-defined using the exact same name but the new-API style and decorated
  with :func:`~gerp.api.v8`. Calls from an old-API context will be
...
* uses of :attr:`~gerp.models.Model._columns` or
  :attr:`~gerp.models.Model._all_columns` should be replaced by
  :attr:`~gerp.models.Model._fields`, which provides access to instances of
  new-style :class:`gerp.fields.Field` instances (rather than old-style
  :class:`gerp.osv.fields._column`).

  Non-stored computed fields created using the new API style are *not*
  available in :attr:`~gerp.models.Model._columns` and can only be
  inspected through :attr:`~gerp.models.Model._fields`
* reassigning ``self`` in a method is probably unnecessary and may break
  translation introspection
* :class:`~gerp.api.Environment` objects rely on some threadlocal state,
  which has to be set up before using them. It is necessary to do so using the
  :meth:`gerp.api.Environment.manage` context manager when trying to use
  the new API in contexts where it hasn't been set up yet, such as new threads
  or a Python interactive environment::

    >>> from gerp import api, modules
...
:class:`~gerp.api.Environment` (for :attr:`~gerp.api.Environment.cr`,
:attr:`~gerp.api.Environment.user` and
:attr:`~gerp.api.Environment.context`) or the current recordset (for ``id``
and ``ids``).
...
* disabling it entirely, by decorating a method with
  :func:`~gerp.api.noguess` there will be no bridging and methods will be
...
* defining the bridge explicitly, this is mostly for methods which are matched
  ...
  (e.g. :func:`~gerp.api.cr_uid_context`) which also passes the current
  context *by keyword*.
* dual implementations using :func:`~gerp.api.v7` and
  :func:`~gerp.api.v8` will be ignored as they provide their own "bridging"
