...
The request object is automatically set on :data:`gerp.http.request` at
the start of the request

.. autoclass:: gerp.http.WebRequest
    :members:
    :member-order: bysource
.. autoclass:: gerp.http.HttpRequest
    :members:
.. autoclass:: gerp.http.JsonRequest
    :members:

Response
========

.. autoclass:: gerp.http.Response
    :members:
    :member-order: bysource
...
:class:`~gerp.models.Model`, but can't use the same mechanism as the
...
.. autoclass:: gerp.http.Controller

and defining methods decorated with :func:`~gerp.http.route`::

    class MyController(gerp.http.Controller):
...
* decorating with :func:`~gerp.http.route` is necessary to keep the method
