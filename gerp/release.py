...
product_name = 'Gerp'
description = 'Gerp Server'
long_desc = '''Gerp is a complete ERP and CRM. The main features are accounting (analytic
...
"""
url = 'https://www.gerp.com'
author = 'OpenERP S.A.'
author_email = 'info@gerp.com'
license = 'LGPL-3'

nt_service_name = "gerp-server-" + series.replace('~','-')
