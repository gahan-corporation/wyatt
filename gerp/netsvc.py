...
class PostgreSQLHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        if not dbname:
            return
        with tools.ignore(Exception), tools.mute_logger('gerp.sql_db'), sql_db.db_connect(dbname, allow_uri=True).cursor() as cr:
            cr.autocommit(True)
...
DEFAULT_LOG_CONFIGURATION = [
    'gerp.http.rpc.request:INFO',
    'gerp.http.rpc.response:INFO',
    ':INFO',
]
PSEUDOCONFIG_MAPPER = {
    'debug_rpc_answer': ['gerp:DEBUG', 'gerp.sql_db:INFO', 'gerp.http.rpc:DEBUG'],
    'debug_rpc': ['gerp:DEBUG', 'gerp.sql_db:INFO', 'gerp.http.rpc.request:DEBUG'],
    'debug': ['gerp:DEBUG', 'gerp.sql_db:INFO'],
    'debug_sql': ['gerp.sql_db:DEBUG'],
    'info': [],
    'warn': ['gerp:WARNING', 'werkzeug:WARNING'],
    'error': ['gerp:ERROR', 'werkzeug:ERROR'],
    'critical': ['gerp:CRITICAL', 'werkzeug:CRITICAL'],
}
