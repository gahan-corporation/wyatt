...
from gerp.modules.module import get_module_root, MANIFEST_NAMES
from gerp.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the Gerp server for your project"""
