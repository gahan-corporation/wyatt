...
.. code-block:: console
    ...
    $ ./gerp-bin scaffold Academy my-modules
...
* start the Odoo server
  ...
  .. code-block:: console
      ...
      $ ./gerp-bin --addons-path addons,my-modules
...
.. tip::
    ...
    .. code-block:: console
        ...
        $ gerp-bin --addons-path addons,my-modules -d academy -u academy
...
#. Because :meth:`~gerp.models.Model.search` returns a set of records
...
:func:`~gerp.http.route` decorator which takes a routing string and a
...
:class:`the inverse relationship <gerp.fields.One2many>` to the *teachers*
model:
...
.. note::
    ...
    * to extend a model in-place, it's :attr:`inherited
      <gerp.models.Model._inherit>` without giving it a new
      :attr:`~gerp.models.Model._name`
